...
@include('dashboard.components.stats')
    <div class="p-3">
        <div class="container-fluid">
            <h1>Noticias</h1>
            <a class="btn btn-primary m-2" href="{{route('news.create')}}">
                Crear nuevo
            </a>
            <div class="py-3">
                <div class="mb-3">
                    <form class="d-flex" role="search" method="GET" action="{{ route('news.index') }}">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="{{route('taggable.create', ['taggableType' => 'news', 'taggableId' => $item->id])}}">
                                    ...
                                    <li>
                                        <form id="delete-form" action="{{ route('news.destroy', $item->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
